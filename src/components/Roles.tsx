...
import { CreateRoleInput, GetRolesResponse, PermissionResponse, CreateRoleResponse } from "../interfaces/auth/roles.interface";
        ...
        <div className={`h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 ${darkMode ? 'dark' : ''}`}>
                ...
                <main className="flex-1 overflow-y-auto p-6 md:p-8 relative">
                    <div className="max-w-7xl mx-auto">
                        <div className="flex justify-between items-center mb-8 align-center">
                            ...
                            <div className="flex bg-gray-100 dark:bg-gray-800 p-1.5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
                                <button
                                    onClick={() => setActiveTab('list')}
                                    className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ease-out flex items-center gap-2 ${activeTab === 'list'
                                ...
                                <button
                                    ...
                                    className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ease-out flex items-center gap-2 ${activeTab === 'create'
                                        ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm ring-1 ring-black/5 dark:ring-white/5'
                                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'
                                        }`}
                                >
                        ...
                        <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 justify-center flex border border-white/20 dark:border-gray-700/50 rounded-2xl shadow-xl overflow-hidden min-h-[60vh]">
                            {activeTab === 'list' ? (
                                            ...
                                            roles.map((role) => (
                                                <div key={role.id} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-5 hover:shadow-lg hover:border-purple-200 dark:hover:border-purple-900 transition-all duration-300 group relative overflow-hidden flex flex-col justify-between h-full">
                                                    ...
                                                    <div className="relative z-10 flex flex-col items-center text-center h-full">
                                                        ...
                                                        <div className="flex items-center justify-center gap-4 my-4 text-xs text-gray-500 dark:text-gray-400 font-medium border-y border-gray-100 dark:border-gray-700 py-3 w-full">
                                                            <div className="flex items-center gap-1.5 tooltip" title="Users assigned">
                                                                <span className="bg-purple-100 dark:bg-purple-900/20 p-1.5 rounded-md text-purple-600 dark:text-purple-400">
                                                                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                                                                </span>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-2 mt-auto relative z-10 w-full">
                                                        <Button
                                                            variant="outline"
                                                            className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700 text-sm h-10"
            ...
            <Dialog open={viewUsersDialogOpen} onOpenChange={setViewUsersDialogOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle>Users with role: {selectedRoleName}</DialogTitle>
                    </DialogHeader>
                                    ...
                                    <div key={member.userId} className="flex items-center gap-3 p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors border border-transparent hover:border-gray-100 dark:hover:border-gray-700 group">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div
                                                ...
                                                className="text-sm font-medium text-gray-900 dark:text-gray-100 truncate hover:text-purple-600 cursor-pointer hover:underline"
                                            >
